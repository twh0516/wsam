...
import com.twh.wsam.student.SearchStudentContract.Presenter;
import com.twh.wsam.student.SearchStudentContract.View;
import java.awt.SystemColor;

public class SearchStudent extends JPanel implements View{
	private static final long serialVersionUID = 1L;
	private JTable table;
	private JTextField textField;
	private String[] searchFields = new String[] {"姓名", "学号"};
		...
		button.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(comboBox.getSelectedIndex() == 0) {
					cmd = CmdType.STUDENT_SEARCH_NAME;
				}else {
					cmd = CmdType.STUDENT_SEARCH_NO;
				}
				presenter.searchStudent(textField.getText(), cmd);
			}
		});
